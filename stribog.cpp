...
namespace{
inline void add_512(const unsigned char* lop, const unsigned char* rop, unsigned char* result)
{
...
inline void xor_512(const unsigned char* lop, const unsigned char* rop, unsigned char* result)
{
    for(int i = 0; i < 64; ++i){
...
inline void add_int_mod512(unsigned char* srcdest, unsigned int num)
{
...
inline void P(unsigned char* state)
{
...
inline void S(unsigned char* state)
{
    for(int i = 0; i < 64; ++i)
        state[i]=stable[state[i]];
}

inline void L(unsigned char* state)
{
...
void get_round_key(unsigned char* K, int i)
{
    xor_512(K, C[i-2], K);
...
void hash_512(const unsigned char* message, unsigned long long length, unsigned char out[64])
{
    unsigned char h[64] = {
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
void hash_256(const unsigned char* message, unsigned long long length, unsigned char out[32])
{
    unsigned char h[64] = {
